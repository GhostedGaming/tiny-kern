...
typedef short              __mlibc_int16;
typedef int                __mlibc_int32;
typedef long                __mlibc_int64;

#define __MLIBC_INT8_C(x)  x
#define __MLIBC_INT16_C(x) x
#define __MLIBC_INT32_C(x) x
#define __MLIBC_INT64_C(x) x##L

#define __MLIBC_UINT8_C(x)  x
#define __MLIBC_UINT16_C(x) x
#define __MLIBC_UINT32_C(x) x##U
#define __MLIBC_UINT64_C(x) x##UL

#define __MLIBC_INTMAX_C(x)  x##LL
#define __MLIBC_UINTMAX_C(x) x##ULL

#define __MLIBC_INT8_MAX  0x7f
#define __MLIBC_INT16_MAX 0x7fff
#define __MLIBC_INT32_MAX 0x7fffffff
#define __MLIBC_INT64_MAX 0x7fffffffffffffffL
...
#define __MLIBC_UINT8_MAX  0xff
#define __MLIBC_UINT16_MAX 0xffff
#define __MLIBC_UINT32_MAX 0xffffffffU
#define __MLIBC_UINT64_MAX 0xffffffffffffffffUL
...
#define __MLIBC_UINT_FAST8_MIN 0
...
#define __MLIBC_UINT_FAST16_MIN 0
...
#define __MLIBC_UINT_FAST32_MIN 0
...
#define __MLIBC_UINT_FAST64_MIN 0

typedef long           __mlibc_intmax;
typedef long           __mlibc_intptr;
typedef long           __mlibc_ptrdiff;
#define __MLIBC_INTMAX_MAX  0x7fffffffffffffffLL
#define __MLIBC_INTMAX_MIN  (-__MLIBC_INTMAX_MAX - 1)
#define __MLIBC_INTPTR_MAX  0x7fffffffffffffffL
#define __MLIBC_INTPTR_MIN  (-__MLIBC_INTPTR_MAX - 1)
#define __MLIBC_PTRDIFF_MAX 0x7fffffffffffffffL
#define __MLIBC_PTRDIFF_MIN (-__MLIBC_PTRDIFF_MAX - 1)

typedef unsigned long  __mlibc_uintmax;
typedef unsigned long  __mlibc_uintptr;
typedef unsigned long  __mlibc_size;
#define __MLIBC_UINTMAX_MAX 0xffffffffffffffffULL
#define __MLIBC_UINTPTR_MAX 0xffffffffffffffffUL
#define __MLIBC_SIZE_MAX    0xffffffffffffffffUL

#define __MLIBC_WCHAR_MAX 0x7fffffff
#define __MLIBC_WCHAR_MIN (-__MLIBC_WCHAR_MAX - 1)

#define __MLIBC_WINT_MAX 0xffffffffU
#define __MLIBC_WINT_MIN 0U

#define __MLIBC_SIG_ATOMIC_MAX 0x7fffffff
#define __MLIBC_SIG_ATOMIC_MIN (-__MLIBC_SIG_ATOMIC_MAX - 1)
...
#define __MLIBC_FASTC8(x) __MLIBC_INT8_C(x)
#define __MLIBC_FASTC16(x) __MLIBC_INT16_C(x)
#define __MLIBC_FASTC32(x) __MLIBC_INT32_C(x)
#define __MLIBC_FASTC64(x) __MLIBC_INT64_C(x)
#define __MLIBC_FASTC_JOIN(a, b) a##b
#define __MLIBC_FASTC_JOIN_EXP(a, b) __MLIBC_FASTC_JOIN(a, b)
#define __MLIBC_INT_FAST8_C(x) __MLIBC_FASTC_JOIN_EXP(__MLIBC_FASTC, __INT_FAST8_WIDTH__)(x)
#define __MLIBC_INT_FAST16_C(x) __MLIBC_FASTC_JOIN_EXP(__MLIBC_FASTC, __INT_FAST16_WIDTH__)(x)
#define __MLIBC_INT_FAST32_C(x) __MLIBC_FASTC_JOIN_EXP(__MLIBC_FASTC, __INT_FAST32_WIDTH__)(x)
#define __MLIBC_INT_FAST64_C(x) __MLIBC_FASTC_JOIN_EXP(__MLIBC_FASTC, __INT_FAST64_WIDTH__)(x)

typedef __INT_FAST8_TYPE__ __mlibc_int_fast8;
#define __MLIBC_INT_FAST8_MAX __INT_FAST8_MAX__
#define __MLIBC_INT_FAST8_MIN (-__INT_FAST8_MAX__ - 1)

typedef __INT_FAST16_TYPE__ __mlibc_int_fast16;
#define __MLIBC_INT_FAST16_MAX __INT_FAST16_MAX__
#define __MLIBC_INT_FAST16_MIN (-__INT_FAST16_MAX__ - 1)

typedef __INT_FAST32_TYPE__ __mlibc_int_fast32;
#define __MLIBC_INT_FAST32_MAX __INT_FAST32_MAX__
#define __MLIBC_INT_FAST32_MIN (-__INT_FAST32_MAX__ - 1)

typedef __INT_FAST64_TYPE__ __mlibc_int_fast64;
#define __MLIBC_INT_FAST64_MAX __INT_FAST64_MAX__
#define __MLIBC_INT_FAST64_MIN (-__INT_FAST64_MAX__ - 1)
...
#define __MLIBC_UFASTC8(x) __MLIBC_UINT8_C(x)
#define __MLIBC_UFASTC16(x) __MLIBC_UINT16_C(x)
#define __MLIBC_UFASTC32(x) __MLIBC_UINT32_C(x)
#define __MLIBC_UFASTC64(x) __MLIBC_UINT64_C(x)
#define __MLIBC_UFASTC_JOIN(a, b) a##b
#define __MLIBC_UFASTC_JOIN_EXP(a, b) __MLIBC_UFASTC_JOIN(a, b)
#define __MLIBC_UINT_FAST8_C(x) __MLIBC_UFASTC_JOIN_EXP(__MLIBC_UFASTC, __INT_FAST8_WIDTH__)(x)
#define __MLIBC_UINT_FAST16_C(x) __MLIBC_UFASTC_JOIN_EXP(__MLIBC_UFASTC, __INT_FAST16_WIDTH__)(x)
#define __MLIBC_UINT_FAST32_C(x) __MLIBC_UFASTC_JOIN_EXP(__MLIBC_UFASTC, __INT_FAST32_WIDTH__)(x)
#define __MLIBC_UINT_FAST64_C(x) __MLIBC_UFASTC_JOIN_EXP(__MLIBC_UFASTC, __INT_FAST64_WIDTH__)(x)

typedef __UINT_FAST8_TYPE__ __mlibc_uint_fast8;
#define __MLIBC_UINT_FAST8_MAX __UINT_FAST8_MAX__
#define __MLIBC_UINT_FAST8_MIN 0

typedef __UINT_FAST16_TYPE__ __mlibc_uint_fast16;
#define __MLIBC_UINT_FAST16_MAX __UINT_FAST16_MAX__
#define __MLIBC_UINT_FAST16_MIN 0

typedef __UINT_FAST32_TYPE__ __mlibc_uint_fast32;
#define __MLIBC_UINT_FAST32_MAX __UINT_FAST32_MAX__
#define __MLIBC_UINT_FAST32_MIN 0

typedef __UINT_FAST64_TYPE__ __mlibc_uint_fast64;
#define __MLIBC_UINT_FAST64_MAX __UINT_FAST64_MAX__
#define __MLIBC_UINT_FAST64_MIN 0
